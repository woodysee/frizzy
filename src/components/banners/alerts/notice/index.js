...
export default function noticeAlertBanner() {
	const colourOfThePaper = "#FFFFFF";
	const colourOfTheAlertBanner = "#F8CE8A";
	const reminderSVG = (
	...
	if (noticeAlertBannerEls.length > 0) {
		for (let i = 0; i < noticeAlertBannerEls.length; i++) {
			noticeAlertBannerEls[i].style.backgroundColor = noticeAlertBannerBGColour;
