...
export default function captionedImagesFileInput () {
  const captionedImageUploadSlots = document.querySelectorAll('.fz-uploader[data-fz-uploader-file-type="image"][data-fz-uploader-variant="squared__captioned"]');
  console.log(captionedImageUploadSlots);
  ...
  for (let i = 0; i < captionedImageUploadSlots.length; i++) {
    captionedImageUploadSlots[i].addEventListener('change', detectChangesOfUploadedImages);
  }
}
